                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        <div className="flex items-center">
                            <Link to="/" className="flex items-center gap-2 text-slate-600 dark:text-slate-300 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="text-center mb-16 space-y-4">
                    <h1 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-6">
                        Conectando Saúde e <span className="text-emerald-600 dark:text-emerald-400">Eficiência</span>
                    </h1>
                ...
                <div className="space-y-12">
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-xl shadow-slate-200/50 dark:shadow-black/20 border border-slate-100 dark:border-slate-700 relative overflow-hidden group hover:border-emerald-500/30 transition-all duration-300">
                        <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                            <Scale className="h-32 w-32 text-emerald-600" />
                        </div>
                        ...
                        <div className="prose prose-slate dark:prose-invert max-w-none">
                            <p className="text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
                                Nossa atuação é fundamentada na <strong className="text-emerald-700 dark:text-emerald-400">Lei Estadual Nº 15.880/2022 do Rio Grande do Sul</strong>, que autoriza e regulamenta o empréstimo, a permuta e a doação de medicamentos e fórmulas nutricionais no âmbito do Sistema Único de Saúde (SUS).
                            </p>
                            <div className="bg-slate-50 dark:bg-slate-900/50 p-4 rounded-lg border-l-4 border-emerald-500 italic text-slate-700 dark:text-slate-400 text-sm">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={idx} className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg border border-slate-100 dark:border-slate-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div className="text-center pt-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link to="/signup" className="inline-flex justify-center items-center px-8 py-3 rounded-xl bg-emerald-600 text-white font-medium hover:bg-emerald-700 shadow-lg shadow-emerald-500/30 transition-all hover:scale-105">
                                Cadastrar minha Instituição
                            </Link>
                            <Link to="/explorar" className="inline-flex justify-center items-center px-8 py-3 rounded-xl bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-medium hover:bg-slate-50 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-600 shadow-sm transition-all hover:scale-105">
